...
#Main function pre-preocess pose
def preprocess_pose(pose_file):
	...
	#Returns a dataframe with preprcessed poses
	print("PATH: ",pose_file)
	with open(pose_file) as f:
		...
		return unique_action_df

#Preprocess UPFALL poses
def upfall_poses():
						...
						if cams is not None:
							for cam in cams:
								...
								if os.path.isdir(cam_path):
									...
									#Perform Pre-processing of poses
									unique_action_df = preprocess_pose(activity_poses)
